import core.physics.thermodynamics.enum as enum
import core.physics.thermodynamics.calculations as calcs
        ...
        case enum.FIRST_THERMODYNAMICS_LAW:
            match option:
                case 1:
                    ...
                    print(f"Изменение внутренней энергии = {calcs.calc_first_thermodynamics_law(heat_amount, work)}")
                case 2:
                    internal_energy_change = float(input("Введите изменение внутренней энергии: "))
                    work = float(input("Введите работу: "))
                    print(f"Кол-во теплоты = {calcs.calc_heat_amount_first_thermodynamics_law(internal_energy_change, work)}")
                case 3:
                    internal_energy_change = float(input("Введите изменение внутренней энергии: "))
                    heat_amount = float(input("Введите кол-во теплоты: "))
                    print(f"Работа = {calcs.calc_work_first_thermodynamics_law(internal_energy_change, heat_amount)}")
                case _:
