...
def calc_first_thermodynamics_law(heat_amount, work):
    return work + heat_amount 

def calc_heat_amount_first_thermodynamics_law(internal_energy_change, work):
    return internal_energy_change - work

def calc_work_first_thermodynamics_law(internal_energy_change, heat_amount):
    return internal_energy_change - heat_amount