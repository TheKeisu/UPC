...
from ..services import thermodynamics_service

class ThermodynamicsView(ttk.Frame):
    def __init__(self, master, *args, **kwargs):
        super().__init__(master, *args, **kwargs)
        self.columnconfigure(1, weight=1)

        ttk.Label(self, text="Thermodynamics - example adapter").grid(row=0, column=0, columnspan=2, sticky="w")
    ...
    def on_compute(self):
        ...
        b = self.b_var.get()
        try:
            res = thermodynamics_service.compute_example(a, b)
