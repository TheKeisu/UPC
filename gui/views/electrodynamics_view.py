...
from ..services import electrodynamics_service

class ElectrodynamicsView(ttk.Frame):
    def __init__(self, master, *args, **kwargs):
        super().__init__(master, *args, **kwargs)
        self.columnconfigure(1, weight=1)

        ttk.Label(self, text="Electrodynamics - example adapter").grid(row=0, column=0, columnspan=2, sticky="w")
    ...
    def on_compute(self):
        ...
        b = self.b_var.get()
        try:
            res = electrodynamics_service.compute_example(a, b)
